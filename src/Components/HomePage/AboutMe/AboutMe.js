  ...
  return (
    ...
    <AOSInitializer/>
      ...
      <AOSInitializer/>
        ...
        <p className='AboutMeP'data-aos="fade-right" data-aos-duration="3000">
        <AOSInitializer/>
I am a Full-stack Developer who is heavily focused on the frontend. I love creating sleek, minimalist websites. In the future I would also like to take part, in both Real Estate, and Stock Market Exchanges,</p>
      ...
      <img src={AMI1} alt="Profile Picture" className="profile-picture" data-aos="fade-left" data-aos-duration="3000" />
